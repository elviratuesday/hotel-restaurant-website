...
reserveerStandaard.addEventListener("click", function(){ reserveerKamer(1);}, false);
reserveerFamilie.addEventListener("click", function(){ reserveerKamer(2);}, false);
reserveerSuite.addEventListener("click", function(){ reserveerKamer(3);}, false);
